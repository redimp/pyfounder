...
## Development environment and release process
 ...
 - create virtualenv with Flask and pyfounder installed into it (latter is installed in
...
install it (`pip install pyfounder.tar.gz`), ensure that configuration file exists and
`PYFOUNDER_SETTINGS` environment variable points to it, ensure that user has access to the
